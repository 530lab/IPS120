...
1) SOLVED! By adding a WHILE loop to methods where the values of magnetic field and status were being queried.
This WHILE loop is checking the length of the response from the IPS120 and the match of it to the certain pattern.
